<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterNew.master" AutoEventWireup="true" CodeFile="ReturnInformation.aspx.cs" Inherits="Admin_ReturnInformation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="flex-row justify-content-center align-items-center mx-auto">
        ...
        <div id="divReturnInformation" runat="server">
            <%--PROFESSIONAL TAX--%>
            <div class="row shadow rounded-bottom"  id="PTAXService" runat="server" visible="false">
            ...
            <%--INCOME TAX--%>
            <div class="row shadow rounded-bottom"  id="INCOMETAXService" runat="server" visible="false">
                <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <%--RUBBER BOARD--%>
            <div class="row shadow rounded-bottom"  id="RUBBERBOARDService" runat="server" visible="false">
                <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <%--DSC--%>
            <div class="row shadow rounded-bottom"  id="DSCService" runat="server" visible="false">
                <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <%--GST--%>
            <div class="row shadow rounded-bottom"  id="GSTService" runat="server" visible="false">
                <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <%--ACCOUNTS--%>
            <div class="row shadow rounded-bottom"  id="ACCOUNTService" runat="server" visible="false">
                <div class="col-lg-12 col-md-12 col-sm-12">
