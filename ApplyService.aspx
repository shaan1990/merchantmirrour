<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterNew.master" AutoEventWireup="true" CodeFile="ApplyService.aspx.cs" Inherits="Admin_ApplyService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="flex-row justify-content-center align-items-center mx-auto">
        ...
        <div class="row shadow rounded-bottom"  runat="server" id="divRegistration" visible="false">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <%--name--%>
        ...
        <div class="row shadow rounded-bottom"  runat="server" id="divCustomerID">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <%--customer id--%>
                <div class="form-group">
        ...
        <div id="RegistrationFormSection" runat="server">
            ...
            <div class="row shadow rounded-bottom" style="background-color: #ffffff;" runat="server" id="divRegFormAccounts" visible="false">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="form-group">
                        <label for="txtConcernProprietorNameACN" class="font-weight-normal">Concern/Proprietor name :</label>
                        <asp:TextBox ID="txtConcernProprietorNameACN" CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="form-group">
                        <label for="txtFileNumberACN" class="font-weight-normal">Accounts Keptin & File Number :</label>
                        <asp:TextBox ID="txtFileNumberACN" CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                    </div>
                </div>
