<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterNew.master" AutoEventWireup="true" CodeFile="ManageDatabase.aspx.cs" Inherits="Admin_ManageDatabase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="flex-row justify-content-center align-items-center mx-auto">
        ...
        <div class="row shadow rounded-bottom mt-2" >
        ...
        <div class="row shadow rounded-bottom mb-3 p-3" >
